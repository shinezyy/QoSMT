...
$GEM5_DIR/build/$arch/gem5.fast\
    ...
    --take-simpoint-checkpoint="$gem5_root/simpoint/$benchmark/simpoints,$gem5_root/simpoint/$benchmark/weights,100000000,5000000"\
    --mem-size=4GB\
    --benchmark="$benchmark"\
    --benchmark_stdout=$output_dir\
    --benchmark_stderr=$output_dir\
    --cpu-type='AtomicSimpleCPU' \
    > $GEM5_DIR/simpoint/checkpoint_out/nohup.$benchmark 2>&1 &
